...
class Telegram extends TelegramBase
{
     ...
     *       'prices' => json_encode([['label' => 'Price', 'amount' => 1500]]), // For example, for a price of US$ 1.45 pass amount = 145
     ...
     *       'need_email' => false, // Optional. Pass True, if you require the user's email address to complete the order
     *       'need_shipping_address' => false, // Optional. Pass True, if you require the user's shipping address to complete the order
     *       'send_phone_number_to_provider' => false, // Optional. Pass True, if user's phone number should be sent to provider
     *       'send_email_to_provider' => false, // Optional. Pass True, if user's email address should be sent to provider
     *       'disable_notification' => false, // Optional. Sends the message silently. Users will receive a notification with no sound.
